...
class MobileNet_v1(nn.Module):
    ...
    def __init__(self, in_channels=3, scale=1.0, num_classes=10, **kwargs):
        ...
        self.conv1 = ConvBNReLU(in_channels, input_channel, 3, stride=2, padding=1, bias=False)
        ...
        self.conv4_2 = DepthSeparableConv2d_conv4_2(last_channel, last_channel, 3, stride=1, padding=1, bias=False)
